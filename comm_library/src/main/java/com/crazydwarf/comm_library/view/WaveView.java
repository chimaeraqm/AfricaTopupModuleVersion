...
public class WaveView extends View
{
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = R.color.colorTransBlue;
    public static final int DEFAULT_FRONT_WAVE_COLOR = R.color.colorBlue;
    ...
    private void createShader() {
        ...
        mDefaultWaterLevel = getHeight() - mDefaultAmplitude;
        ...
        wavePaint.setColor(ContextCompat.getColor(mContext,mBehindWaveColor));
        for (int beginX = 0; beginX < endX; beginX++) {
            double wx = beginX * mDefaultAngularFrequency;
            float beginY = (float) (mDefaultWaterLevel + mDefaultAmplitude * Math.sin(wx));
            //canvas.drawLine(beginX, beginY, beginX, endY, wavePaint);
            canvas.drawLine(beginX, 0, beginX, /*endY-*/beginY, wavePaint);

            waveY[beginX] = beginY;
        }

        //wavePaint.setColor(mFrontWaveColor);
        wavePaint.setColor(ContextCompat.getColor(mContext,mFrontWaveColor));
