...
public class RechargeAliActivity_backup extends BaseActivity
{
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(RechargeAliActivity_backup.this, "支付成功", Toast.LENGTH_SHORT).show();
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(RechargeAliActivity_backup.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                default:
...
//        sendRequest(request_func,request_name);
    ...
    public void payV2(View v)
    {
         ...
         */
        UserUtil.showToastLong("Pay $0.01 to Target Alipay account.");
...
//        final String res_OrderInfo = ori_OrderInfo;
        Runnable payRunnable = new Runnable()
        {
            ...
            public void run() {
                try {
                    PayTask alipay = new PayTask(RechargeAliActivity_backup.this);
        ...
        switch (requestCode) {
            case Constants.PERMISSIONS_REQUEST_CODE: {
                ...
                if (grantResults.length == 0) {
                    UserUtil.showToastLong("无法获取支付宝 SDK 所需的权限, 请到系统设置开启");
                    return;
                }
                ...
                // 所需的权限均正常获取
                UserUtil.showToastLong("支付宝 SDK 所需的权限已经正常获取");
            }
        }
    }
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e)
            {
                runOnUiThread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Toast.makeText(RechargeAliActivity_backup.this, "fail to connect to sever", Toast.LENGTH_SHORT).show();
                    }
                });
                e.printStackTrace();
            }
